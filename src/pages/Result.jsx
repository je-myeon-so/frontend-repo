...
const Result = () => {
  ...
  const feedbackData = {
    answer: {
      content: `아, 안녕하세요...! 어... 저는... 풀, 풀스택 개발자로 성장하고 있는 지연우입니다. 어... 제가, 음... 사용자 경험을... 최우선으로 고려하면서, 프, 프론트엔드는 React를 쓰고... 어... 백엔드는 Node.js랑 Django를, 음... 활용해서 웹 애플리케이션을 개발, 해왔습니다. 어... 특히, 그... 아! BENTO! 네, BENTO라는 강의 요약 웹 서비스! 네, 그걸 기획하고, 음... 개발을 하면서, 음... 데이터 처리...와, 어... UI/UX 최적화가... 음... 되게, 되게 중요하구나, 하고 느꼈어요. 그리고, 어... 또... xv6! 네! xv6 운영체제 개조 프로젝트를 하면서, 시스템 프로그래밍에 대한, 어... 그... 개념? 이해? 그런 점... 조금 더 넓었던 것 같고요...! 어... 저는, 어... 음... 그... 사용자의 문제를... 기술로 해결하는 거에... 음... 보람을 느끼고...! 어... 새로운 기술도... 음... 빠르게 익히고, 적용하는... 음... 역량... ? 네, 그게, 좀... 있다고 생각합니다. 그래서, 어... 앞으로, 팀과 함께, 음... 성장하면서, 좋은, 아니, 가치 있는...! 그런 서비스를 만들어가고 싶습니다. 어... 아, 네..! 감사합니다...!`
    },
    feedback: {
